...
<div class="wrapper section medium-padding">
	...
	<div class="content section-inner">
            ...
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                ...
                <div <?php post_class('single post notice'); ?>>
                    ...
                    <?php if (cc_portfolio_query()->have_posts()) : ?>

                            <div class="posts grid-posts">

                            <?php while (cc_portfolio_query()->have_posts()) : cc_portfolio_query()->the_post(); ?>
	...
	<?php if ( cc_portfolio_query()->max_num_pages > 1 ) : ?>
